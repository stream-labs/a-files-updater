...
function generate_file(filedir, filename, filecontentextended = "", emptyfile = false) {
...
function generate_server_dir(testinfo) {
  ...
  generatePromises.push(generate_file(update_subdirpath, "test2.txt", "new change"))
  generatePromises.push(generate_file(update_subdirpath, "file2.jpeg"))
  generatePromises.push(generate_file(update_subdirpath, "file4.log.txt"))
  generatePromises.push(generate_file(update_subdirpath, "file5.1"))
  generatePromises.push(generate_file(update_subdirpath, "file 1.txt"))
...
function generate_initial_dir(testinfo, dirpath = "") {
  ...
  generatePromises.push(generate_file(dirpath, "file1.exe"))
  generatePromises.push(generate_file(dirpath, "file2.txt"))
  generatePromises.push(generate_file(dirpath, "file2.jpeg"))
  generatePromises.push(generate_file(dirpath, "test2.txt", "old content", false))
  generatePromises.push(generate_file(dirpath, "dir\\file3.zip"))
  var allPromise = Promise.all(generatePromises)
  allPromise.then(console.log, console.error)
...
function generate_result_dir(dirpath) {
  ...
  generatePromises.push(generate_file(dirpath, "file2.txt"))
  generatePromises.push(generate_file(dirpath, "file2.jpeg"))
  generatePromises.push(generate_file(dirpath, "test2.txt", "new change"))
  generatePromises.push(generate_file(dirpath, "file4.log.txt"))
  generatePromises.push(generate_file(dirpath, "file5.1"))
  generatePromises.push(generate_file(dirpath, "file 1.txt"))
  generatePromises.push(generate_file(dirpath, "dir\\file3.zip"))
